...
const ICONS = {
    ...
    deeplink: '<path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>',
    ...
    cidr: '<rect x="9" y="2" width="6" height="6" rx="1"/><rect x="2" y="16" width="6" height="6" rx="1"/><rect x="16" y="16" width="6" height="6" rx="1"/><path d="M12 8v3"/><path d="M5 16v-3h14v3"/>',
    ...
    keypair: '<circle cx="7" cy="7" r="3.8"/><path d="m9.7 9.7 4.3 4.3"/><circle cx="17" cy="17" r="3.8"/><path d="m14 14 1.5-1.5"/><path d="M12 2v2"/><path d="M2 12h2"/>',
    encrypt: '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><rect x="9.2" y="10.5" width="5.6" height="4.6" rx="1"/><path d="M10.6 10.5V9.4a1.4 1.4 0 0 1 2.8 0v1.1"/>',
    ...
    imgb64: '<rect x="2" y="2.5" width="13" height="13" rx="2"/><circle cx="6.2" cy="6.7" r="1.2"/><path d="m2 12.2 3.2-3.2 3.6 3.6"/><polyline points="17.5 15.5 21 19 17.5 22.5"/><polyline points="13.5 22.5 10 19 13.5 15.5"/>',
...
const TOOLS = [
    ...
    { file: 'ssh-key.html', name: 'SSH Key Converter', desc: 'Convert private keys between PEM and PuTTY .ppk, and public keys between every format and fingerprint', icon: 'key', cat: 'Crypto & Auth' },
    ...
    { file: 'keypair.html', name: 'Key Pair Generator', desc: 'Generate RSA / EC / Ed25519 key pairs and secrets, inspect any PEM / JWK key, download as PEM / DER / JWK', icon: 'keypair', cat: 'Crypto & Auth' },
    ...
    { file: 'deeplink.html', name: 'Deep Link Tester', desc: 'Build custom-scheme, universal / app link & intent URLs with a QR for each', icon: 'deeplink', cat: 'Utilities' },
    ...
    { file: 'iam-diff.html', name: 'IAM Policy Diff', desc: 'Compare two AWS IAM policy sets — by the permissions they actually grant, or statement by statement as they are written', icon: 'iam', cat: 'Utilities' },
    { file: 'iam-normalize.html', name: 'IAM Normalize', desc: 'Merge the duplicate and overlapping statements in an AWS IAM policy into one canonical document', icon: 'iamnorm', cat: 'Utilities' },
