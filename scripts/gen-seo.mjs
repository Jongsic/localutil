...
const SEO = {
    ...
    'ssh-key.html': {
        ...
        desc: 'Convert SSH keys: extract public keys, switch private keys between OpenSSH / PEM and PuTTY .ppk, and view any public key as OpenSSH / PEM / RFC 4716 with SHA256 and MD5 fingerprints. Runs 100% in your browser — keys never leave your machine.',
    },
    'keypair.html': {
    ...
    'iam-diff.html': {
        title: 'AWS IAM Policy Diff / Compare',
        desc: `Compare two AWS IAM policy sets by the permissions they actually grant — statements flattened, wildcards matched as wildcards, explicit Deny applied — or diff them statement by statement as written. ${LOCAL}`,
    },
    'iam-normalize.html': {
